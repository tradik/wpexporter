...
<tr><td><code>--limit-per-type</code></td><td>Export at most N of each kind — posts, pages, each custom type. Combines with <code>--limit</code>, whichever is smaller</td><td><code>0</code> (no limit)</td></tr>
